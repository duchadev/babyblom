<?php	if(!defined('_source')) die("Error");
	...
	function save_photo(){
		...
		if($id){
			...
			if($photo1 = upload_image("file_vi", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name)){
				$data['photo_vi'] = $photo1;
			...
			if($photo2 = upload_image("file_en", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name1)){
				$data['photo_en'] = $photo2;
			...
			if($photo3 = upload_image("file_cn", 'Jpg|jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name2)){
				$data['photo_cn'] = $photo3;
