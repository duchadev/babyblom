  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <?php } ?>
		<?php if($_GET['type']!='chinhsach'){?><td class="sortCol"><div>Hình ảnh<span></span></div></td><?php } ?>
    ...
    <tbody>
       ...
       <td>
        ...
        <?php } ?> 
		<?php if($_GET['type']!='chinhsach'){?>
		<td class="title_photo_data">
		
		<img src="<?= _upload_baiviet.$items[$i]['photo'] ?>" width="100">
