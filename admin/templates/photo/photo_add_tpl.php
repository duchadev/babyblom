...
<form name="supplier" id="validate" class="form" action="index.php?com=photo&act=save_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow lang_hidden lang_vi active">
			...
			<div class="formRight">
				<input type="text" name="ten_vi" title="Nhập tên hình ảnh" id="ten_vi" class="tipS " value="" />
			</div>
			<div class="clear"></div>
		</div>	
		<div class="formRow lang_hidden lang_en">
			...
			<div class="formRight">
				<input type="text" name="ten_en" title="Nhập tên hình ảnh" id="ten_en" class="tipS " value="" />
			</div>
			<div class="clear"></div>
		</div>	
		<div class="formRow lang_hidden lang_cn">
			...
			<div class="formRight">
				<input type="text" name="ten_cn" title="Nhập tên hình ảnh" id="ten_cn" class="tipS " value="" />
			</div>
			<div class="clear"></div>
		</div>	
