...
<div class="control_frm" style="margin-top:0;">
	...
	<input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=photo&act=add_photo<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'" />
        ...
        <input type="button" class="blueB" value="Xoá" onclick="ChangeAction('index.php?com=photo&act=man_photo&multi=del<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>');return false;" /><?php } ?>
    </div>  
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center">
                <img src="<?=_upload_hinhanh.$items[$i]['photo_vi']?>" width="100" border="0" height="100"/>
                </td>
      ...
      <td align="center">
        ...
        <td class="actBtns">
			...
			<?php if($_GET['type']!='quangcao'){?>
            <a href="" onclick="CheckDelete('index.php?com=photo&act=delete_photo&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'); return false;" title="" class="smallButton tipS" original-title="Xóa hình ảnh"><img src="./images/icons/dark/close.png" alt=""></a> <?php } ?>       </td>
      </tr>
         <?php } ?>
                </tbody>
  </table>
