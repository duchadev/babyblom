<?php
      ...
      $d->reset();
      $sql = "SELECT COUNT(*) as num FROM #_donhang";
      $d->query($sql);
...
<div class="wrapper">
        ...
        <div class="userNav">
            <ul>
                ...
                <li class="ddnew "<?= $hide ?>><a title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Thông báo</span><span class="numberTop"><?=$tong_count?></span></a>
				...
				<li><a href="../sitemap.php"><img src="images/icons/topnav/repeat.png" alt="" /><span>Cập nhật sitemap </span></a></li>
            </ul>
        </div>
        <div class="clear"></div>
    </div>
