...
<form class="form-horizontal" enctype="multipart/form-data" id="form-register" id="form-register" role="form" method="post">		
	...
	<div class="ttl"><h4>Thông tin tài khoản</h4></div>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<label class="radio-inline">
				  <input type="radio" name="reg[gender]" id="inlineRadio1" <?php if(@$member_log['gender']==0) echo 'checked'; ?> value="0"> Nam
				</label>
				<label class="radio-inline">
				  <input type="radio" name="reg[gender]" id="inlineRadio2" <?php if(@$member_log['gender']==1)echo 'checked'; ?> value="1"> Nữ
				</label>
			</div>
		</div>
		...
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Địa chỉ liên hệ <span>*</span></label>
			<div class="col-sm-6">
				<input type="text" class="form-control contact_address-input" value="<?=@$member_log['address']?>" name="reg[address]" id="inputEmail3" placeholder="Địa chỉ" required/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control contact_phone-input" value="<?=@$member_log['phone2']?>" name="reg[phone2]" id="inputEmail3" placeholder="Điện thoại" required />
			</div>
		</div>
