...
<?php
$d->reset();
$d->query("select photo_vi from #_photo where hienthi = 1	and type='slider' order by stt,id desc");
...
<?php 
	foreach($slider as $k=>$v){
		?>
		<div data-thumb="" data-src="<?=_upload_hinhanh_l.$v['photo_vi']?>">
		<?php /*<div class="camera_caption fadeFromBottom   ">
